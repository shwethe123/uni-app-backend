...
routers.post('/api/eletricity_meter', [
    ...
    body('last_meter').notEmpty().withMessage("last_meter is required"),
    body('total_meter').notEmpty().withMessage("total_meter is required"),
...
routers.delete('/api/eletricity_meter', electricity_meter_controller.destory);
